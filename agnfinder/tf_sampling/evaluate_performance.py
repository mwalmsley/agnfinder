...
def check_parameter_bias(samples, true_params):
    ...
    for param_n, param in enumerate(range(7)):  # TODO
        ax = axes[param_n]
...
if __name__ == '__main__':
    ...
    logging.getLogger().setLevel(logging.DEBUG)  # some third party library is mistakenly setting the logging somewhere...
