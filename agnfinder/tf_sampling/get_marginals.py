...
if __name__ == '__main__':
    """
    Example use: python agnfinder/tf_sampling/get_marginals.py --save-dir results/extra_filters
    """
    parser = argparse.ArgumentParser(description='Find AGN!')
    parser.add_argument('--save-dir', dest='save_dir', type=str)
    parser.add_argument('--bins', dest='bins', type=int, default=50)
    parser.add_argument('--params', dest='n_params', type=int, default=7)
    ...
    for galaxy_loc in tqdm.tqdm(galaxy_locs):
        marginals = np.zeros((args.n_params, 50))
        for param_n in range(args.n_params):
